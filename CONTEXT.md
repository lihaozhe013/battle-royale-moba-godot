...
- It creates the directional light, `WorldEnvironment`, and static ground in code while preserving the prior orientation, geometry, and palette. The current first-pass lighting tune uses 1.35 directional-light energy and 1.35 ambient-light energy.
