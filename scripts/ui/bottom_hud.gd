...
@onready
var _hp_fill: ColorRect = $HUDPanel/HUDContainer/ResourceSection/HPContainer/HPFill
@onready
var _hp_label: Label = $HUDPanel/HUDContainer/ResourceSection/HPContainer/HPLabel
@onready
var _mana_fill: ColorRect = $HUDPanel/HUDContainer/ResourceSection/ManaContainer/ManaFill
@onready
var _mana_label: Label = $HUDPanel/HUDContainer/ResourceSection/ManaContainer/ManaLabel
@onready
var _stats_label: Label = $HUDPanel/HUDContainer/StatsTextContainer/StatsLabel
@onready
var _skill_section: HBoxContainer = $HUDPanel/HUDContainer/ResourceSection/SkillSection
@onready
var _item_container: VBoxContainer = $HUDPanel/HUDContainer/ItemAndBackpack/ItemSection
@onready
var _backpack_section: HBoxContainer = $HUDPanel/HUDContainer/ItemAndBackpack/BackpackSection
