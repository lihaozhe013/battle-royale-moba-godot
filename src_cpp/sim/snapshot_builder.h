...
private:
    static void _build_players(entt::registry &reg, const godot::Ref<SimSnapshot> &snap);
    static void _build_bots(entt::registry &reg, const godot::Ref<SimSnapshot> &snap);
