...
inline int roll_bot_level_for_role(entt::registry &reg, BotRole role, std::mt19937 &rng) {
    switch (role) {
        case BotRole::Fodder:
        ...
        case BotRole::Stalker: {
            ...
            int off = std::uniform_int_distribution<int>(-GameConfig::StalkerOffset, GameConfig::StalkerOffset)(rng);
...
inline BotTierMult tier_mult(BotTier t) {
    switch (t) {
        case BotTier::Elite:
            return {GameConfig::EliteHpMul, GameConfig::EliteAtkMul,
                GameConfig::EliteAspMul, GameConfig::EliteSpeedMul, GameConfig::EliteVisionMul};
        case BotTier::Boss:
            return {GameConfig::BossHpMul, GameConfig::BossAtkMul,
                GameConfig::BossAspMul, GameConfig::BossSpeedMul, GameConfig::BossVisionMul};
        case BotTier::Normal:
        default:
            return {GameConfig::NormalHpMul, GameConfig::NormalAtkMul,
